...
import 'package:newstoday/modelclass/news.dart';
import 'package:newstoday/screen/Detailednews.dart';
import 'package:newstoday/service/apiservice.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<News>>(future: client.fetchNews(),builder: (BuildContext,AsyncSnapshot<List<News>> snapshot) {
